...
#import "/vendor/typst-blog-core/typst/core/shared.typ": calver-iso-datetime, export-target, main-font, heading-font, math-font, base-path
...
#import "/vendor/typst-blog-core/typst/core/article-seo.typ": article-seo-data
#import "/vendor/typst-blog-core/typst/components/article-parts.typ": article-header, article-actions, post-navigation
...
#import "/vendor/typst-blog-core/typst/components/widgets.typ": widget-author, widget-search
...
#let article(
  ...
  // Typst accepts ISO 639 language codes here, while the HTML document uses
  // the more precise site-level zh-CN locale.
  set text(lang: "zh", font: main-font)
